...
<head>
    ...
    <title>MedicaL Lab</title><!--begin::Primary Meta Tags-->
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="bi bi-boxes"></i>
                                <p>
                                    Patients
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="http://medicallab/patients/create" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Add New</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="http://medicallab/patients" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Show All</p>
                                    </a> </li>
                            </ul>
                        </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="http://medicallab/tests/create" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                    <p>Add New</p>
                                </a> </li>
                            <li class="nav-item"> <a href="http://medicallab/tests" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                    <p>Show All</p>
                                </a> </li>
                        </ul>
                    </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item"> <a href="http://medicallab/orders/create" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                <p>Add New</p>
                            </a> </li>
                        <li class="nav-item"> <a href="http://medicallab/orders" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                <p>Show All</p>
                            </a> </li>
                    </ul>
                </li>
